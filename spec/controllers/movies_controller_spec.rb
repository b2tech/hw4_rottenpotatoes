...
describe MoviesController do
  ...
  describe 'displaying movies' do
    ...
    context 'index' do
      it 'should redirect if params match with session' do
      ...
      it 'should show movies ordered by release date' do
  ...
  describe 'creating movies' do
    ...
    it 'should create new entry' do
      post :create, {:movie => {:title => 'test Movie', :rating => 'R', :release_date => 10.years.ago, :director => 'Brian B'}}
  ...
  describe 'updating movies' do
    it 'should show edit movie form' do
      get :edit, {:id => 1}
